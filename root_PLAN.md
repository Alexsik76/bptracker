...
**Поточний стан:** ASP.NET Core 10, PostgreSQL 16, Serilog + Seq. Local OCR primary, Gemini fallback. Тести покривають OCR-шляхи.
...
**Поточний стан:** Vue 3 PWA, Web Share Target для фото з галереї, офлайн-черга для ручних замірів.
